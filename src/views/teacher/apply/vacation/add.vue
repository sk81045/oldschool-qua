  ...
  <base-content>
   <div class="q-pa-md">
    ...
    <div class="q-gutter-y-md column"  style="max-width: 270px;margin-left: 4rem;">
      ...
      <q-input v-model="form.reason" bottom-slots label="请假原因" type="textarea">
          <template v-slot:before>
          <q-item-label style="color: #355B75; font-size: 1rem; margin-top: 1rem;width: 5rem;">请假原因</q-item-label>
        </template>
      </q-input>
      <template>
