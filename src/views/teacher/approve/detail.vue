 ...
 <div class="q-pa-md flex justify-center">
    ...
    <div style="max-width: 90%;"  v-for="(item,index) in list" :key="index">
        ...
        ">
          ...
          <q-item-section side v-if="item.state == 1">
            ...
            <q-item-section side v-else-if="item.state == 2">
            ...
            <q-item-label class="text-h6" style="color: blue; width: 5rem">
              <q-icon
              name="close"
              size="14px"
              class="q-ml-xs"
...
import { StudentApproveList } from '@/api/Vacation'
export default {
